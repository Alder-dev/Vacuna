    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-0 text-gray-800"><b>LISTA DE PERSONAS<input class="form-control" id="search" type="text" placeholder="Buscar..."></b></h1>
                      <?php if($this->session->flashdata("mod")): ?>
                    <div class="container" style="width: 315px">
                    <div class="card border-left-success" style="width: 310px">
                       <div class="card text-center" style="width: 305px">
                        <div class="card" style="background-color: #49C25F; color: black; width: 300px">
                        <h4>Usuario Modificado</h4>
                        </div>
                     </div> 
                    </div>
                    </div>
                          ...
                          <table id="example" class="table table-striped">
                            <thead>
                                ...
                                <tbody id="tbdy">
                                    ...
                                    <td>
                                    <a href="<?php echo base_url('editar-persona/'. $persona->_id); ?>" class="fas fa-user-edit fa-1x" style="color: #0086F6;"></a>
                                    <a href="<?php echo base_url('eliminar-persona/'. $persona->_id); ?>" class="far fa-trash-alt fa-1x" style="color: #DC4646;"></a>   
                                    </td>
                                    </tr>
                                    <?php endforeach; ?>
                                    <?php endif; ?>
